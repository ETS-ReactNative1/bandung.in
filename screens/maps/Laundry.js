...
export const Laundry = ({ navigation, route }) => {
    return (
      <Box bg="#fff" w="100%" h="100%">
        <ZStack h="100%">
            <Box bg='black' w='100%' h='120%' flex={1} overflow='hidden'>
                <WebView setBuiltInZoomControls={false} source={{ uri: 'https://www.google.com/maps/d/u/0/embed?mid=1pj6p7c3JnuxrEeRnMsWU-bryZrGlVgwO&ehbc=2E312F' }} />
            </Box>
