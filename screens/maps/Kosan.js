...
export const Kosan = ({ navigation, route }) => {
    return (
      <Box bg="#fff" w="100%" h="100%">
        <ZStack h="100%">
            <Box bg='black' w='100%' h='120%' flex={1} overflow='hidden'>
                <WebView setBuiltInZoomControls={false} source={{ uri: 'https://www.google.com/maps/d/u/0/embed?mid=1n3FJ9-dbmNAdi3h3I6lYLOIhjjNG-t77&ehbc=2E312F' }} />
            </Box>
