...
export const Angkot = ({ navigation, route }) => {
    return (
        <Box bg="#fff" w="100%" h="100%">
            <ZStack h="100%">
                <Box mt={1} bg='black' w='100%' h='110%' flex={1} overflow='hidden'>
                    <WebView setBuiltInZoomControls={false} source={{ uri: 'https://projectkiri.id/' }} />
                </Box>
